  ...
  const features = [
    {
      ...
      description:
        "Conecte-se facilmente com sua conta do GitHub e importe automaticamente todos os seus repositórios públicos.",
    },
    {
      icon: "🎨",
    ...
    },
    {
      ...
      description:
        "Publique seu portfolio com um clique e mantenha-o sempre atualizado com seus projetos mais recentes.",
    },
  ];
    ...
    <S.AboutContainer>
      ...
      <S.MissionSection>
        <S.ContentWrapper>
          ...
          <Text variant="body" color="primary" align="left">
            Facilitar a vida dos desenvolvedores oferecendo uma maneira simples
            e elegante de apresentar seus projetos do GitHub. Acreditamos que
            todo desenvolvedor merece ter um portfolio profissional que reflita
            verdadeiramente seu talento e dedicação.
          </Text>
        </S.ContentWrapper>
      </S.MissionSection>
          ...
          <S.BenefitsContent>
            <div>
              ...
              <Text variant="body" color="secondary" align="left">
                Desenvolvido por desenvolvedores, para desenvolvedores. Nossa
                plataforma entende suas necessidades e oferece ferramentas que
      ...
      <S.TechnologySection>
        <S.ContentWrapper>
          ...
          <Text variant="body" color="secondary" align="center">
            ...
            performance, escalabilidade e uma experiência excepcional.
          </Text>
          <S.TechStack>
            <S.TechItem>
              <Image
      ...
      <S.CTASection>
        <S.ContentWrapper>
          ...
          <Text variant="body" color="secondary" align="center">
            Junte-se a centenas de desenvolvedores que já estão usando nossa
